...
const Contact = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center lg:text-left">
      <h1 className="text-5xl font-bold pl-7 my-5">CONTACT DETAILS</h1>
      <p className="pl-7">Please feel free to get in touch anytime, whether for work inquiries or to just say hello.
