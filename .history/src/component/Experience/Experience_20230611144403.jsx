...
const Experience = () => {
    return (
        <div id='Experience' className="bg-base-200 hover:h-full py-30 h-screen  ">
            ...
            <p className="px-4 text-2xl px-15"> I work at Web development. I am very interested in web development site. I have done some web projects for the great knowledge of the following language I have learnt very well:
           </p>
