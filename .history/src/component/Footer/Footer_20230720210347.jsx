...
const <footer className="footer p-10 bg-neutral text-neutral-content">
  <div>
    <span className="footer-title">Doctors Health</span> 
...
export default <footer className="footer p-10 bg-neutral text-neutral-content">
  <div>
