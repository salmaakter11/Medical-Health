...
import nerphrologist from '../../img/nerphrologist.jpg'
...
const Services = () => {
    return (
        <div id='Service' >
            <h1 className=' text-center text-neutral font-bold text-5xl py-20 bg-sky-200 '>Services</h1>
...
<div className="card w-96 bg-base-100 shadow-xl card lg:w-96 hover:shadow- p-0 bg-base-200  rounded-md hover:scale-90 duration-500">
  <figure className="px-10 pt-10">
    <img src={surgery} alt="Shoes" className="rounded-xl" />
  </figure>
  <div className="card-body items-center text-center">
    <h2 className="card-title">Dental Caring </h2>
...
<div className="card w-96 bg-base-100 shadow-xl card lg:w-96 hover:shadow- p-0 bg-base-200  rounded-md hover:scale-90 duration-500">
  <figure className="px-10 pt-10">
    <img src={nerphrologist} alt="Shoes" className="rounded-xl" />
  </figure>
  <div className="card-body items-center text-center">
...
<div className="card w-96 bg-base-100 shadow-xl card lg:w-96 hover:shadow- p-0 bg-base-200  rounded-md hover:scale-90 duration-500">
  <figure className="px-10 pt-10">
    <img src={skin} alt="Shoes" className="rounded-xl" />
  </figure>
  <div className="card-body items-center text-center">
