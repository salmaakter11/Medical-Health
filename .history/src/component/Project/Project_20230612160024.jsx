...
// const Project = () => {
//     return (
//         <div id='Project' className="my-44 max-w rounded-lg shadow-2xl h-screen  bg-pink-50">
//             <h1 className="text-center font-bold text-50  text-4xl ">Project/Thisis</h1>

// <div className="hero-content flex-col lg:flex-row-reverse pl-20 max-w rounded-lg">
// <div className='pl-10 '>
// <h1 className="font-bold  ">Thisis</h1>
// <ul className="list-disc max-w rounded-lg" >
...
// <div className='pl-10'>
// <h1 className="font-bold max-w rounded-lg bg-pink-50 ">Project</h1>
