...
const Services = () => {
    return (
        <div>
<h1 className="my-10 text-center font-bold text-50 decoration-double text-cyan-600 text-xl">Services</h1>
<div id="Service" className='flex flex-wrap justify-around'>
            <div className="card w-96 bg-base-100 shadow-xl bg-base-200 my-3 ">
...
<div className="card w-96 bg-base-100 shadow-xl bg-base-200 my-10  ">
  ...
  <figure><img src="./component/img/img2" alt="Shoes" /></figure>
</div>
