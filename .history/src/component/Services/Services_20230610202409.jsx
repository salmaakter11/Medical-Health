                    ...
                    <div className="card lg:w-96 hover:shadow-lg hover:shadow-red-500/50 p-0 bg-base-200  rounded-md hover:scale-110 duration-500">
                        <div className="card-body  ">
                            ...
                            <div className='flex justify-between'>
                                <h2 className="  font-bold text-4xl text-center text-neutral ">Web Development Services</h2>
                                <div className="badge font-bold bg-black my-1 border-2 text-white">US 100$</div>
                            </div>
