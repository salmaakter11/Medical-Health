...
const Service = () => {
    return (
        <div id="Service">
            <div className=' py-40  bg-pink-50'>
                <h1 className=' text-center text-neutral font-bold text-5xl py-4 '>Select your preferred package</h1>

                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 p-10 ml-10'>

                    {/* ======web development services ===== */}
                    <div className="card lg:w-96 hover:shadow-lg hover:shadow-yellow-800 z-0  rounded-md hover:scale-110 duration-500">
                    ...
                    <div className="card lg:w-96 hover:shadow-lg hover:shadow-yellow-800 z-0 bg-base-200  rounded-md hover:scale-110 duration-500">
                        <div className="card-body  ">
                            {/* heading  */}
                            <div className='flex justify-between'>
