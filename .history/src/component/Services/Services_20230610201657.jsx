                    ...
                    <div className="card lg:w-96 hover:shadow-lg hover:shadow-red-500/50 p-0 bg-base-200  rounded-md hover:scale-110 duration-500">
                        <div className="card-body  ">
                            ...
                            <div className='flex justify-between'>
                                <h2 className=" text-neutral font-bold text-4xl text-center ">Web Development Services</h2>
                                <div className="badge font-bold bg-red-500 border-0 text-white">US 100$</div>
                            </div>
