import salmaimg  from '../../'
import './About.css'
const About = () => {
    return (
        <div >

            <div className="bg bg-fixed  h-screen bg-no-repeat bg-cover  bg-no-repeat bg-center">
                
            </div>
            <div id="About" className="hero  bg-base-200 px-10 ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img
                        src={salmaimg}
                        className=" lg:max-w-sm  rounded-lg hover:shadow-lg shadow-yellow-800 z-0"
                        alt="img"
                    />
