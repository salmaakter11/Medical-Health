...
const Experience = () => {
    return (
        <div id='Skill' className=" hover:h-full  bg-pink-50 max-w rounded-lg shadow-2xl my-32">
            <h1 className="font-bold text-center text-4xl ">Skills</h1>

            <div  className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 pl-36'>
                  <div>
                    <h1></h1>
