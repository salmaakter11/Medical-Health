...
const Experience = () => {
    return (
        <div id='Skill' className=" hover:h-full py-30 h-screen pl-20  my-15 bg-pink-50 scroll-py-44 ">
            ...
            <div  className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 ml-20 my-10'>
                  <div>
                    <h1></h1>
                  ...
                  <div>
                  <img className='h-20 pl-30 hover:shadow-lg hover:shadow-yellow-800 z-0' src={sql} alt="" />
                  </div>

                  <div>
                  <img className='h-20 pl-30 hover:shadow-lg hover:shadow-yellow-800 z-0' src={php} alt="" />
                  </div>

                  <div>
                    <img className='h-20 pl-30 hover:shadow-lg hover:shadow-yellow-800 z-0' src={wordpress} alt="" />
                    </div>

                  <div>
                  <img className='h-20 pl-30 hover:shadow-lg hover:shadow-yellow-800 z-0' src={react} alt="" />
                  </div>

                  <div>
                    <img className='h-20 pl-30 hover:shadow-lg hover:shadow-yellow-800 z-0' src={node} alt="" />
                  </div>
           </div>
