...
const Experience = () => {
    return (
        <div id='Skill' className=" hover:h-full py-30 h-screen pl-20 pr-25  my-15 bg-base-200 ">
            ...
            <div  className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pl-10 my-10'>
                  <div>
                    <h1></h1>
